...
extern const string pointCloudTopic = "/livox/lidar"; ///livox/lidar /back_lslidar_point_cloud_filtered / os1_cloud_node/points
extern const string imuTopic = "/imu/data"; //imu_rion
...
// VLP-16
 ...
 extern const int Horizon_SCAN = 1800;//1800
